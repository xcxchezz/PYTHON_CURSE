...
class House:
    ...
    def __init__(self):
        ...
        self.cat_food = 0
    def __str__(self):
        return 'В доме еды осталось {}, денег осталось {}, грязи в доме {}, кошачей еды в доме {}'.format(
...
class Cat:
    def __init__(self, name=None):
        ...
        self.cat_name = name
    def __str__(self):
        return 'Я {}, сытость {}'.format(self.cat_name, self.cat_fullness)
    def go_to_the_house(self, house):
        self.cat_house = house
        self.cat_fullness -= 10
        print('{} пришел в дом'.format(self.cat_name))
    def cut_wall(self):
